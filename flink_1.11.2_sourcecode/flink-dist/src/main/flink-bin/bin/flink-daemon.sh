...
# TODO 马中华 注释： 启动命令： start  stop 等
STARTSTOP=$1

# TODO 马中华 注释： 启动角色： standalonesession, taskexecutor 等
DAEMON=$2
...
case $DAEMON in
    (taskexecutor)
        # TODO 马中华 注释： TaskManager 的启动主类 TaskManagerRunner
    ...
    (standalonesession)
        # TODO 马中华 注释： JobManager 的启动主类 StandaloneSessionClusterEntrypoint
...
case $STARTSTOP in
    ...
    (start)
        ...
        # TODO 马中华 注释： $JAVA_RUN = $JAVA_HOME/bin/java
