...
/**
 * // TODO 注释： 流运算符的基本接口。
 * // TODO 注释： 实现者将实现 {@link org.apache.flink.streaming.api.operators.OneInputStreamOperator}
 * // TODO 注释： {@link org.apache.flink.streaming.api.operators.TwoInputStreamOperator}
 * // TODO 注释： 之一，以创建用于处理元素的运算符。
 ...
 *
 * // TODO 注释： 类{@link org.apache.flink.streaming.api.operators.AbstractStreamOperator} *提供了生命周期和属性方法的默认实现。
 ...
 *
 * // TODO 注释： {@code StreamOperator}的方法保证不会被同时调用。
 * // TODO 注释： 另外，如果使用计时器服务，则还保证不会与{@code StreamOperator}上的方法同时调用计时器回调。
