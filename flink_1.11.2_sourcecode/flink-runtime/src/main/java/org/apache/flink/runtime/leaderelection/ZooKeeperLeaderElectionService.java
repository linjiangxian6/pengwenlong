...
/**
 * // TODO 注释： 多个 JobManager 的领导者选举服务。使用 ZooKeeper 选择领先的 JobManager。
 * Leader election service for multiple JobManager. The leading JobManager is elected using ZooKeeper.
 *
 * // TODO 注释： 当前领导者的地址及其领导者会话 ID 也会通过 ZooKeeper 发布。
...
public class ZooKeeperLeaderElectionService implements LeaderElectionService, LeaderLatchListener, NodeCacheListener, UnhandledErrorListener {
	...
	public void start(LeaderContender contender) throws Exception {
		...
		synchronized(lock) {
			 ...
			 *
			 */
			//TODO 这里搜索isLeader可能this是WebMonitorEndpoint，也可能是ResourceManager，DefaultDispatcherRunner，三种情况都要点进去
			//TODO ***** 搜索isLeader()
	...
	public void isLeader() {
		synchronized(lock) {
			if(running) {
				 ...
				 */
				//TODO ***** 进来的如果是DefaultDispatcherRunner点开实现类DefaultDispatcherRunner
				//TODO ***** 进来的如果是WebMonitorEndpoint点开实现类WebMonitorEndpoint
				//TODO ***** 进来的如果是ResouceManager实现类ResouceManager
				//TODO ***** JobManagerRunnerImpl
