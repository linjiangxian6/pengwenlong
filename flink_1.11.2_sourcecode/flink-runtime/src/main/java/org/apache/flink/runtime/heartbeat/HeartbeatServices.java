...
public class HeartbeatServices {
	...
	public HeartbeatServices(long heartbeatInterval, long heartbeatTimeout) {
		...
		Preconditions
			.checkArgument(heartbeatInterval <= heartbeatTimeout, "The heartbeat timeout should be larger or equal than the heartbeat interval.");
	 ...
	 */
	public <I, O> HeartbeatManager<I, O> createHeartbeatManager(ResourceID resourceId, HeartbeatListener<I, O> heartbeatListener,
