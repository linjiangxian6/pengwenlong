...
/**
 * // TODO 注释： 该服务负责监视所有已注册职位的 job manager
 * This service has the responsibility to monitor the job leaders (the job manager which is
 * leader for a given job) for all registered jobs.
 *
 * // TODO 注释： 在获得工作领导权并由工作领导者服务发现后，该服务将尝试与工作领导者建立联系。
 * Upon gaining leadership for a job and detection by the job leader service,
 * the service tries to establish a connection to the job leader.
 *
 * // TODO 注释： 成功建立连接后，作业负责人侦听器将收到有关新作业负责人及其连接的通知。
 * After successfully establishing a connection, the job leader listener is notified about the new job
 * leader and its connection.
 *
 * // TODO 注释： 万一工作领导者失去领导能力，也会通知工作领导者听众。
 * In case that a job leader loses leadership, the job leader listener is notified as well.
 */
