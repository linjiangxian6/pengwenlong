...
/**
 * // TODO 注释： 维护这个 TM 上所有 TaskSlot 与 Task、及 Job 的关系；
 * // TODO 注释： 维护这个 TM 上所有 TaskSlot 的状态；
 * // TODO 注释： TaskSlot 在进行 allocate/free 操作，通过 TimeService 做超时检测。
 *
 * // TODO 注释： 当一个 slot 被调度执行了一个 Task, 就会生成一个 TaskSlot 对象
 * // TODO 注释： Task Slot
 *
 * // TODO 注释： 关于 Slot 的管理： SlotManagerImpl 主节点启动的时候，已经启动了这个组件
 *
 ...
 *
 * // TODO 注释： 具体实现类是： TaskSlotTableImpl
 */
