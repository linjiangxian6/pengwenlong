...
/**
 * // TODO 注释： 一个单个任务产生的数据的结果分区
 * A result partition for data produced by a single task.
 *
 * // TODO 注释： 此类是逻辑{@link IntermediateResultPartition}的运行时部分。本质上， 结果分区是{@link Buffer}实例的集合。
 * // TODO 注释： 缓冲区被组织在一个或多个{@link ResultSubpartition}实例中，
 * // TODO 注释： 这些实例进一步根据消耗任务的数量和数据{@link DistributionPattern}对数据进行分区。
 ...
 *
 * // TODO 注释： consume 结果分区的 Task 必须请求其子分区之一。
 * // TODO 注释： 请求远程（请参见{@link RemoteInputChannel}）或本地（请参见{@link LocalInputChannel}）发生
 ...
 * <h2>Life-cycle</h2>
 *
 * // TODO 注释： 每个结果分区的生命周期都有三个（可能是重叠的）阶段： Produce Consume Release
 ...
 *
 * // TODO 注释： 代表由一个Task的生成的数据，和ExecutionGraph中的IntermediateResultPartition一一对应
 */
