 ...
 * </ol>
 * // TODO 注释： 每个InputGate会包含一个以上的InputChannel，和ExecutionGraph中的ExecutionEdge一一对应，
 * // TODO 注释： 也和ResultSubpartition一对一地相连，即一个InputChannel接收一个ResultSubpartition的输出
 */
public abstract class InputChannel {
	...
	protected InputChannel(SingleInputGate inputGate, int channelIndex, ResultPartitionID partitionId, int initialBackoff, int maxBackoff, Counter numBytesIn,
