...
public class SessionDispatcherLeaderProcessFactory implements DispatcherLeaderProcessFactory {
	...
	public SessionDispatcherLeaderProcessFactory(AbstractDispatcherLeaderProcess.DispatcherGatewayServiceFactory dispatcherGatewayServiceFactory,
		JobGraphStoreFactory jobGraphStoreFactory, Executor ioExecutor, FatalErrorHandler fatalErrorHandler) {
		this.dispatcherGatewayServiceFactory = dispatcherGatewayServiceFactory;

		// TODO 注释： HaServicesJobGraphStoreFactory
	...
	public DispatcherLeaderProcess create(UUID leaderSessionID) {
		 ...
		 *  	创建的结果是：ZooKeeperJobGraphStore
		 *  第三个参数：jobGraphStoreFactory.create() = ZooKeeperJobGraphStore
		 */
		return SessionDispatcherLeaderProcess
			.create(leaderSessionID, dispatcherGatewayServiceFactory, jobGraphStoreFactory.create(), ioExecutor, fatalErrorHandler);
	}
}
