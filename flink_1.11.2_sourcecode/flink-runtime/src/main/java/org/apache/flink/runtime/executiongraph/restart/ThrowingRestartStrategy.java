...
/**
 * // TODO 注释： 通过在任何方法调用上抛出{@link IllegalStateException}来验证它未被使用的重启策略。
 * A restart strategy that validates that it is not in use by throwing {@link IllegalStateException} on any method call.
 */
