...
/**
 * // TODO 注释： JobGragh 中的一个 定点抽象定义
 * The base class for job vertexes.
 *
 * // TODO 注释： 经过优化后符合条件的多个StreamNode可能会chain在一起生成一个JobVertex，
 * // TODO 注释： 即一个JobVertex包含一个或多个operator，JobVertex的输入是JobEdge，输出是IntermediateDataSet
 */
public class JobVertex implements java.io.Serializable {
	...
	// TODO 注释： JobGragh 中的该 JobVertex 的并行度
	...
	// TODO 注释： 这个 JobVertex 对应的 Operator 的名字
