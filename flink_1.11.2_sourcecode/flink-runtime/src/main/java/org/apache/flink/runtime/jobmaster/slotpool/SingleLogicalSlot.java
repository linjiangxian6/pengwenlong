...
public class SingleLogicalSlot implements LogicalSlot, PhysicalSlot.Payload {
	...
	private static final AtomicReferenceFieldUpdater<SingleLogicalSlot, Payload> PAYLOAD_UPDATER = AtomicReferenceFieldUpdater
		.newUpdater(SingleLogicalSlot.class, Payload.class, "payload");

	private static final AtomicReferenceFieldUpdater<SingleLogicalSlot, State> STATE_UPDATER = AtomicReferenceFieldUpdater
		.newUpdater(SingleLogicalSlot.class, State.class, "state");
	...
	public SingleLogicalSlot(SlotRequestId slotRequestId, SlotContext slotContext, @Nullable SlotSharingGroupId slotSharingGroupId, Locality locality,
		SlotOwner slotOwner) {
	...
	private void returnSlotToOwner(CompletableFuture<?> terminalStateFuture) {
		terminalStateFuture.whenComplete((Object ignored, Throwable throwable) -> {
